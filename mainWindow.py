...
import bill, unbill, merch, homeWidget, chorePlay, email_ui, config, sendtoprinter, dopyFiles
...
class mainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.database = dopyFiles.Students(self.databaseFilePath)
...
##########connecting universal menuActions:
        ...
        #New Dept List
        self.menuItems["newdeptlist"][3].triggered.connect(lambda: dopyFiles.newDeptList(self))
        #Add Nick
        self.menuItems["addnick"][3].triggered.connect(lambda: dopyFiles.addNickWidget(self))
        #Send 2 Printer
        ...
        #password Widget
        self.menuItems["changepassword"][3].triggered.connect(lambda: dopyFiles.passwordWidget(self))
        #cofigure option
