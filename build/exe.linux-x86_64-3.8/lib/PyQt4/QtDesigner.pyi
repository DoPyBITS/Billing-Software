...
class QDesignerActionEditorInterface(QtGui.QWidget):

    def __init__(self, parent: QtGui.QWidget, flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...) -> None: ...
...
class QAbstractFormBuilder(sip.simplewrapper):
    ...
    def save(self, dev: QtCore.QIODevice, widget: QtGui.QWidget) -> None: ...
    def load(self, device: QtCore.QIODevice, parent: typing.Optional[QtGui.QWidget] = ...) -> QtGui.QWidget: ...
...
class QDesignerFormEditorInterface(QtCore.QObject):
    ...
    def topLevel(self) -> QtGui.QWidget: ...
    def extensionManager(self) -> 'QExtensionManager': ...


class QDesignerFormWindowInterface(QtGui.QWidget):
    ...
    def __init__(self, parent: typing.Optional[QtGui.QWidget] = ..., flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...) -> None: ...

    def objectRemoved(self, o: QtCore.QObject) -> None: ...
    def widgetRemoved(self, w: QtGui.QWidget) -> None: ...
    def changed(self) -> None: ...
    def activated(self, widget: QtGui.QWidget) -> None: ...
    def aboutToUnmanageWidget(self, widget: QtGui.QWidget) -> None: ...
    def widgetUnmanaged(self, widget: QtGui.QWidget) -> None: ...
    def widgetManaged(self, widget: QtGui.QWidget) -> None: ...
    def resourceFilesChanged(self) -> None: ...
    def geometryChanged(self) -> None: ...
    def selectionChanged(self) -> None: ...
    def featureChanged(self, f: 'QDesignerFormWindowInterface.Feature') -> None: ...
    def fileNameChanged(self, fileName: str) -> None: ...
    def mainContainerChanged(self, mainContainer: QtGui.QWidget) -> None: ...
    def setFileName(self, fileName: str) -> None: ...
    def setGrid(self, grid: QtCore.QPoint) -> None: ...
    def selectWidget(self, widget: QtGui.QWidget, select: bool = ...) -> None: ...
    def clearSelection(self, update: bool = ...) -> None: ...
    def setDirty(self, dirty: bool) -> None: ...
    def setFeatures(self, f: 'QDesignerFormWindowInterface.Feature') -> None: ...
    def unmanageWidget(self, widget: QtGui.QWidget) -> None: ...
    def manageWidget(self, widget: QtGui.QWidget) -> None: ...
    ...
    @typing.overload
    @staticmethod
    def findFormWindow(w: QtGui.QWidget) -> 'QDesignerFormWindowInterface': ...
    @typing.overload
    @staticmethod
    def findFormWindow(obj: QtCore.QObject) -> 'QDesignerFormWindowInterface': ...
    def isDirty(self) -> bool: ...
    def isManaged(self, widget: QtGui.QWidget) -> bool: ...
    def setMainContainer(self, mainContainer: QtGui.QWidget) -> None: ...
    def mainContainer(self) -> QtGui.QWidget: ...
    def grid(self) -> QtCore.QPoint: ...
    def cursor(self) -> 'QDesignerFormWindowCursorInterface': ...
    def core(self) -> QDesignerFormEditorInterface: ...
    def setIncludeHints(self, includeHints: typing.Sequence[str]) -> None: ...
    ...
    def author(self) -> str: ...
    def hasFeature(self, f: 'QDesignerFormWindowInterface.Feature') -> bool: ...
    def features(self) -> 'QDesignerFormWindowInterface.Feature': ...
    @typing.overload
    def setContents(self, dev: QtCore.QIODevice) -> None: ...
    @typing.overload
...
class QDesignerFormWindowCursorInterface(sip.simplewrapper):
    ...
    def isWidgetSelected(self, widget: QtGui.QWidget) -> bool: ...
    def resetWidgetProperty(self, widget: QtGui.QWidget, name: str) -> None: ...
    def setWidgetProperty(self, widget: QtGui.QWidget, name: str, value: typing.Any) -> None: ...
    def setProperty(self, name: str, value: typing.Any) -> None: ...
    def selectedWidget(self, index: int) -> QtGui.QWidget: ...
    def selectedWidgetCount(self) -> int: ...
    def hasSelection(self) -> bool: ...
    def widget(self, index: int) -> QtGui.QWidget: ...
    def widgetCount(self) -> int: ...
    def current(self) -> QtGui.QWidget: ...
...
class QDesignerFormWindowManagerInterface(QtCore.QObject):
    ...
    def core(self) -> QDesignerFormEditorInterface: ...
    def createFormWindow(self, parent: typing.Optional[QtGui.QWidget] = ..., flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...) -> QDesignerFormWindowInterface: ...
    ...
    def actionAdjustSize(self) -> QtGui.QAction: ...
    def actionBreakLayout(self) -> QtGui.QAction: ...
    def actionGridLayout(self) -> QtGui.QAction: ...
    def actionSplitVertical(self) -> QtGui.QAction: ...
    def actionSplitHorizontal(self) -> QtGui.QAction: ...
    def actionVerticalLayout(self) -> QtGui.QAction: ...
    def actionHorizontalLayout(self) -> QtGui.QAction: ...
    def actionRedo(self) -> QtGui.QAction: ...
    def actionUndo(self) -> QtGui.QAction: ...
    def actionRaise(self) -> QtGui.QAction: ...
    def actionLower(self) -> QtGui.QAction: ...
    def actionSelectAll(self) -> QtGui.QAction: ...
    def actionDelete(self) -> QtGui.QAction: ...
    def actionPaste(self) -> QtGui.QAction: ...
    def actionCopy(self) -> QtGui.QAction: ...
    def actionCut(self) -> QtGui.QAction: ...


class QDesignerObjectInspectorInterface(QtGui.QWidget):
...
class QDesignerPropertyEditorInterface(QtGui.QWidget):
...
class QDesignerWidgetBoxInterface(QtGui.QWidget):
...
class QDesignerContainerExtension(sip.simplewrapper):
    ...
    def insertWidget(self, index: int, widget: QtGui.QWidget) -> None: ...
    def addWidget(self, widget: QtGui.QWidget) -> None: ...
...
class QDesignerCustomWidgetInterface(sip.simplewrapper):
    ...
    def createWidget(self, parent: QtGui.QWidget) -> QtGui.QWidget: ...
...
class QFormBuilder(QAbstractFormBuilder):
    ...
    def customWidgets(self) -> typing.List[QDesignerCustomWidgetInterface]: ...
    def setPluginPath(self, pluginPaths: typing.Sequence[str]) -> None: ...
