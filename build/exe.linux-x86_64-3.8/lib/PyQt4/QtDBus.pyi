...
class QDBusAbstractInterface(QtCore.QObject):
    ...
    def asyncCallWithArgumentList(self, method: str, args: typing.Sequence[typing.Any]) -> 'QDBusPendingCall': ...
    ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], receiver: QtCore.QObject, returnMethod: QT_SLOT, errorMethod: QT_SLOT) -> bool: ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], returnMethod: typing.Callable[..., None], errorMethod: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def callWithCallback(self, method: str, args: typing.Sequence[typing.Any], callable: typing.Callable[..., None]) -> bool: ...
    def callWithArgumentList(self, mode: 'QDBus.CallMode', method: str, args: typing.Sequence[typing.Any]) -> 'QDBusMessage': ...
    @typing.overload
...
class QDBusConnection(sip.simplewrapper):
    ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, callable: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, signature: str, callable: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, callable: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, callable: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, signature: str, callable: typing.Callable[..., None]) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, receiver: QtCore.QObject, slot: QT_SLOT) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, argumentMatch: typing.Sequence[str], signature: str, callable: typing.Callable[..., None]) -> bool: ...
    ...
    @typing.overload
    def callWithCallback(self, message: 'QDBusMessage', receiver: QtCore.QObject, returnMethod: QT_SLOT, errorMethod: QT_SLOT, timeout: int = ...) -> bool: ...
    @typing.overload
    def callWithCallback(self, message: 'QDBusMessage', returnMethod: typing.Callable[..., None], errorMethod: typing.Callable[..., None], timeout: int = ...) -> bool: ...
    @typing.overload
    def callWithCallback(self, message: 'QDBusMessage', receiver: QtCore.QObject, slot: QT_SLOT, timeout: int = ...) -> bool: ...
    @typing.overload
    def callWithCallback(self, message: 'QDBusMessage', callable: typing.Callable[..., None], timeout: int = ...) -> bool: ...
...
class QDBusMessage(sip.simplewrapper):
    ...
    def setArguments(self, arguments: typing.Sequence[typing.Any]) -> None: ...
    ...
    @typing.overload
    def createReply(self, arguments: typing.Sequence[typing.Any] = ...) -> 'QDBusMessage': ...
    @typing.overload
...
class QDBusPendingCallWatcher(QtCore.QObject, QDBusPendingCall):
    ...
    def finished(self, self: 'QDBusPendingCallWatcher') -> None: ...
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    def connection(self) -> QDBusConnection: ...
    def setWatchMode(self, mode: 'QDBusServiceWatcher.WatchMode') -> None: ...
    ...
    def setWatchedServices(self, services: typing.Sequence[str]) -> None: ...
