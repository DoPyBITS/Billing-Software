...
class QDomNode(sip.simplewrapper):
    ...
    def nextSiblingElement(self, tagName: str = ...) -> 'QDomElement': ...
    ...
    @typing.overload
    def save(self, a0: QtCore.QTextStream, a1: int) -> None: ...
    @typing.overload
...
class QDomDocument(QDomNode):
    ...
    @typing.overload
    def setContent(self, data: typing.Union[QtCore.QByteArray, bytes, bytearray], namespaceProcessing: bool) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    ...
    @typing.overload
    def setContent(self, buffer: typing.Union[QtCore.QByteArray, bytes, bytearray]) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
