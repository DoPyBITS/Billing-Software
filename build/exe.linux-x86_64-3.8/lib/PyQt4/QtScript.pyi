...
class QScriptEngine(QtCore.QObject):
    ...
    @typing.overload
    def newFunction(self, signature: typing.Callable[[QScriptContext, 'QScriptEngine'], 'QScriptValue'], length: int = ...) -> 'QScriptValue': ...
    @typing.overload
    def newFunction(self, signature: typing.Callable[[QScriptContext, 'QScriptEngine'], 'QScriptValue'], prototype: 'QScriptValue', length: int = ...) -> 'QScriptValue': ...
