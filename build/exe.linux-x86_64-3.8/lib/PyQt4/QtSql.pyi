...
class QSqlDriver(QtCore.QObject):
    ...
    def stripDelimitersImplementation(self, identifier: str, type: 'QSqlDriver.IdentifierType') -> str: ...
    def isIdentifierEscapedImplementation(self, identifier: str, type: 'QSqlDriver.IdentifierType') -> bool: ...
    def subscribedToNotificationsImplementation(self) -> typing.List[str]: ...
    def unsubscribeFromNotificationImplementation(self, name: str) -> bool: ...
    def subscribeToNotificationImplementation(self, name: str) -> bool: ...
...
class QSqlRelationalDelegate(QtGui.QItemDelegate):
    ...
    def createEditor(self, parent: QtGui.QWidget, option: QtGui.QStyleOptionViewItem, index: QtCore.QModelIndex) -> QtGui.QWidget: ...
