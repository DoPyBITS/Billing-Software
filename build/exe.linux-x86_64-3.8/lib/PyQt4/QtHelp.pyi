...
class QHelpContentWidget(QtGui.QTreeView):
...
class QHelpEngineCore(QtCore.QObject):
    ...
    def files(self, namespaceName: str, filterAttributes: typing.Sequence[str], extensionFilter: str = ...) -> typing.List[QtCore.QUrl]: ...
...
class QHelpIndexModel(QtGui.QStringListModel):
...
class QHelpIndexWidget(QtGui.QListView):
...
class QHelpSearchQuery(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, field: 'QHelpSearchQuery.FieldName', wordList: typing.Sequence[str]) -> None: ...
    @typing.overload
...
class QHelpSearchEngine(QtCore.QObject):
    ...
    def search(self, queryList: typing.Sequence[QHelpSearchQuery]) -> None: ...
...
class QHelpSearchQueryWidget(QtGui.QWidget):
    ...
    def setQuery(self, queryList: typing.Sequence[QHelpSearchQuery]) -> None: ...
    def query(self) -> typing.List[QHelpSearchQuery]: ...


class QHelpSearchResultWidget(QtGui.QWidget):
